...
@section('content')
    <x-helium-ui::filters>
        <x-helium-ui::filters.item label="All" filter="all" />
        <x-helium-ui::filters.item label="Stats" filter="ui1" />
        <x-helium-ui::filters.item label="Misc" filter="ui2" />
        <x-helium-ui::filters.item label="Forms" filter="ui3" />
        <x-helium-ui::filters.item label="Datatable" filter="ui4" />
    </x-helium-ui::filters>
    ...
    <div data-helium-filter-target="ui4">
        <x-helium-ui::box>
            ...
            <livewire:category-datatable sharedKey="category-datatable" paginationSize=10 queryPrefix="c" />
